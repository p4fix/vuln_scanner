        ...
        <div className="space-y-8">
          ...
          <div className="card-3d rounded-xl p-6">
            <Routes>
              ...
              <Route path="/website-check" element={<WebsiteCheck apiService={apiService} />} />
              <Route path="/port-scan" element={<PortScan apiService={apiService} />} />
              <Route path="/banner-grab" element={<BannerGrab apiService={apiService} />} />
